@auth
<nav x-data="{ open: false }" style="background:#051726;" class="border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link class="text-white"  href="{{ route('Preguntas_Frecuentes') }}" :active="request()->routeIs('Preguntas_Frecuentes')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link   href="{{ route('Preguntas_Frecuentes') }}" :active="request()->routeIs('Preguntas_Frecuentes')">
                        {{ __('Preguntas Frecuentes') }}
                    </x-responsive-nav-link>
        </div>
